...
call :BackupOne "HK" "C:\Users\Lenovo\Desktop\data\香港\timeline" "\\TAIHU\public\公共\步步安_呼呼睡持续跟踪\呼呼睡持续跟踪\香港钧溢养老院\数据整理\5月" "COPY_DIR"
call :BackupRawData "HK" "C:\Users\Lenovo\Desktop\data\香港\rawdata" "\\TAIHU\public\公共\步步安_呼呼睡持续跟踪\呼呼睡持续跟踪\香港钧溢养老院\数据整理\5月"
...
call :BackupOne "Jiangyan" "C:\Users\Lenovo\Desktop\data\姜堰\timeline" "\\TAIHU\public\公共\步步安_呼呼睡持续跟踪\呼呼睡持续跟踪\姜堰福利院\数据解析\解析的数据\5月份" "COPY_DIR"
call :BackupRawData "Jiangyan" "C:\Users\Lenovo\Desktop\data\姜堰\rawdata" "\\TAIHU\public\公共\步步安_呼呼睡持续跟踪\呼呼睡持续跟踪\姜堰福利院\数据解析\解析的数据\5月份"
...
call :BackupOne "Hefei" "C:\Users\Lenovo\Desktop\data\合肥\timeline" "\\TAIHU\public\公共\步步安_呼呼睡持续跟踪\呼呼睡持续跟踪\合肥养老院\数据解析\解析的数据\5月份" "COPY_DIR"
call :BackupRawData "Hefei" "C:\Users\Lenovo\Desktop\data\合肥\rawdata" "\\TAIHU\public\公共\步步安_呼呼睡持续跟踪\呼呼睡持续跟踪\合肥养老院\数据解析\解析的数据\5月份"
